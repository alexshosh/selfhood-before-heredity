...
\pagestyle{fancy}
\fancyhf{}
\fancyfoot[C]{\small Preprint --- DOI: 10.5281/zenodo.22262347}
...
\begin{center}
\textit{Preprint. DOI: \href{https://doi.org/10.5281/zenodo.22262347}{10.5281/zenodo.22262347}}\\
...
\section*{10. Peptide material -\textgreater{} Q (the peptide-rich liquid coacervate phase): short peptide coacervation}\label{peptide-material---q-short-peptide-coacervation}}
...
We suspect that this evolutionary pattern---from QAG/self through a connected peptide network toward protein-like organization---is general: each modern protein descends from a QAG-associated evolutionary lineage, perhaps even from its own distinct QAG, and different QAGs are themselves connected to one another through variation and selection from a smaller set of earlier organizations. This is a conjecture beyond what the present framework demonstrates, and a natural target for future work.
